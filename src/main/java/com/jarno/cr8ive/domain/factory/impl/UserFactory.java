...
public class UserFactory implements IUserFactory {
    ...
    @Override
    public ModeratorAccount createModeratorAccount(long id, String firstName, String lastName, String emailAddress, String birthday, String profilePicture, Set<Roles> userRoles, String passwordHash) {
        return new ModeratorAccount(id, firstName, lastName, emailAddress, birthday, profilePicture, userRoles, passwordHash);
    }
