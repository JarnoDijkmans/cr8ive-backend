...
public interface IUserFactory {
    ...
    IUser createModeratorAccount(long id, String firstName, String lastName, String emailAddress, String birthday, String profilePicture, Set<Roles> userRoles, String passwordHash);
